...
class PayPalRecurring extends Component
{
    ...
    public static function getPayPalUrl() {
        return self::SANDBOX ?'https://www.sandbox.paypal.com' : 'https://www.paypal.com';
    }

    public static function getPayPalApiUrl() {
        return self::SANDBOX ? 'https://api-3t.sandbox.paypal.com/nvp' : 'https://api-3t.paypal.com/nvp';
    }
    ...
    public function SetExpressCheckout($params)
    {
        ...
        return self::getPayPalUrl()."/cgi-bin/webscr?cmd=_express-checkout&token=" . $result['TOKEN'];
    }
