...
use frontend\assets\AppAdminAsset;
...
AppStudentAsset::register($this);

$current_url = Url::current();
?>
<?php $this->beginPage() ?>
    <!DOCTYPE html>
    <html lang="<?= Yii::$app->language ?>" ng-app="TLA_STUDENT">
    <head>
                    ...
                    <div class="navbar-right">
                        <div>
                            <ul class="nav navbar-nav navbar-right main-menu__navigation-menu">
                                <li class="<?= $current_url == Url::toRoute('student/dashboard') ? 'active' : '' ?>"><a
                                        href="<?= Url::toRoute('student/dashboard') ?>"><i class="fa fa-tasks"></i>
                                        Dashboard</a></li>
                                <li class="<?= $current_url == Url::toRoute('student/chat') ? 'active' : '' ?>"><a
                                        href="<?= Url::toRoute('student/chat') ?>"><i class="fa fa-comment-o" aria-hidden="true"></i>
                                        Chat</a></li>
                                <li class="<?= $current_url == Url::toRoute('student/practice-exam') ? 'active' : '' ?>"><a
                                        href="<?= Url::toRoute('student/practice-exam') ?>"><i class="fa fa-question-circle"></i>
                                        Exam practice</a></li>
                                <li class="<?= $current_url == Url::toRoute('student/finished-quizzes') ? 'active' : '' ?>"><a
                                        href="<?= Url::toRoute('student/finished-quizzes') ?>"><i class="fa fa-list-alt"></i>
                                        Finished quizzes</a></li>
                                <li class="<?= $current_url == Url::toRoute('student/search') ? 'active' : '' ?>"><a
                                        href="<?= Url::toRoute('student/search') ?>"><i class="fa fa-search"></i>
                                        Search</a></li>
                                <li class="<?= $current_url == Url::toRoute('student/account-settings') ? 'active' : '' ?>"><a
                                        href="<?= Url::toRoute('student/account-settings') ?>"><i class="fa fa-cogs"></i> Account
                                        </a></li>
...
<section class="blue-half-bg"></section>
    <div class="container">
        <div class="alert alert-warning alert-dismissible tutors_announce" role="alert" style="<?= isset($this->params['announce'])?'':'display:none;' ?>">
            <?= isset($this->params['announce'])?$this->params['announce']:''; ?>
        </div>
        <div class="main-container" style="<?= isset($this->params['announce'])?'top:115px':'' ?>">
            <?= Breadcrumbs::widget([
