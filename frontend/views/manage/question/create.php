<div ng-controller="QuestionCtrl" ng-init="init()">
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <textarea ng-model="quizQuestion" class="form-control" rows="6"
                          placeholder="New question ..."></textarea>
            </div>
                        ...
                        <div class="panel-body">
                            <ul class="list-group answers-list">
                                <li ng-repeat="answer in answers track by $index" class="list-group-item answer-list-item" ng-click="setRightAnswer($index, $event)">
                                    ...
                                    <button ng-click="deleteAnswer($index)" class="btn btn-xs btn-danger pull-right"><span class="glyphicon glyphicon-remove"></span></button>
                                    ...
                                    <span editable-text="answer.content" e-form="textBtnForm" onaftersave="updateAnswer($index)" onbeforesave="checkName($data)">
                                        <span ng-bind="answer.content"></span>
                                     </span>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="form-inline form-group">
                <div class="form-group">
                    <button ng-click="saveQuestion()" class="btn btn-primary">Save</button>
                </div>
