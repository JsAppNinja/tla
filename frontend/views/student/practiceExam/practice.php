        ...
        <div ng-controller="PracticeExamController" ng-init="showQuestions(<?= $quizpractice->id ?>)">
            <form style="opacity:0" action="/student/finish-practice" method="POST" id="practice">
                ...
                <div style="position: fixed;z-index: 2000000;top: 30px;right: 73px;" class="visible-xs-block">
                    ...
                    <a href="javascript:;" ng-click="stopPractice(false)" class="btn btn-primary"><span class="glyphicon glyphicon-ok"></span> Finish</a>
                </div>
                <div class="row">
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <h1 class="exam-title" ng-bind="practice.name"></h1>
                        <ul style="margin: 0;padding: 0;">
                            <li ng-repeat="question in practice.questions track by $index" class="shadowed practice_question">
                                <div class="question" ng-bind-html="question.content" style="margin-bottom: 10px;"></div>
                                <img class="img-responsive" ng-repeat="image in question.images track by $index" ng-src="{{image.path}}"/>
                                    ...
                                    <li ng-repeat="answer in question.answers track by answer.id">
                                        <div class="radio">
                                            <label style="width: 100%;">
                                                ...
                                                <span class="answer_item" ng-bind-html="answer.content"></span>
                                            </label>
                                        </div>
                                    </li>
                                </ul>
...
<script type="text/ng-template" id="stopPractice">
    ...
    <div class="ngdialog-buttons">
        <button type="button" class="ngdialog-button ngdialog-button-secondary" ng-click="confirm(1)">Stop practicing</button>
        <button type="button" class="ngdialog-button ngdialog-button-primary" ng-click="closeThisDialog(0)">Continue practicing</button>
    </div>
</script>
<script>
    (function ($) {
