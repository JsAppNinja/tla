...
$percent = ceil(($result['correct'] - $result['essays']) / count($result['checkedAnswers']) * 100);
        ...
        <div class="col-md-12">
            <div class="form-group">
                <div class="topic_title">
                    <span style="cursor: pointer" id="tutor_comment" class="closed"><i class="fa fa-caret-down"
                                                             aria-hidden="true"></i> Tutor comment</span>
                </div>
            </div>
